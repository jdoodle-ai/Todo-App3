    ...
    if task:
        ...
        data = {
            ...
            'messages': [
                {
                    'role': 'system',
                    'content': 'You are an AI assistant that helps users divide their tasks into subtasks using OpenAI API. Only return a maximum of 6 subtasks and nothing else. Use the ChatCompletion endpoint, make the call with requests library. Be mindful of syntax errors especially while creating strings in python. The subtasks should be generated based on the task title and appended to the task description.'
                },
                {
                    'role': 'user',
                    'content': task.title
