    ...
    if task:
        ...
        data = {
            ...
            'messages': [
                {
                    'role': 'system',
                    'content': 'You are an AI assistant that helps users divide their tasks into subtasks using OpenAI API. Return a maximum of 6 subtasks and nothing else. Use the ChatCompletion endpoint.'
                },
                {
                    'role': 'user',
                    'content': task.title
